...
const steps = [
 ...
 {number:"04",title:"출동 배정",shortDescription:"현장 담당자에게 사건 전달",question:"누가 현장에 대응하는가",description:"사건 위치와 도로 상황을 기준으로 가까운 현장 대응팀에 사건을 전달합니다.",tags:["대응팀","예상 도착","출동 상태"],kind:"dispatch",input:"확정 사건·위치·도로 상황",process:"대응팀 추천·사건 전달·출동 요청",result:"강북 현장대응 2팀 · 배정 완료",duration:5500},
...
function ProductPreview({kind}:{kind:(typeof steps)[number]["kind"]}){
 ...
 if(kind==="dispatch")return <div className="flow-preview flow-preview--dispatch"><div className="flow-map"><RoadbogoLocationMarker/><span>사건 위치</span><b>강북 2팀 · 4.2km</b><em>예상 7분</em></div><div className="flow-team"><span>사건 INC-2026-0715 · 추천 대응팀<strong>강북 현장대응 2팀</strong></span><button type="button">출동 연결</button></div></div>;
