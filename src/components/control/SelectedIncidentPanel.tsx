...
const work:Record<DashboardIncident["status"],{description:string;button:string}>={
 NEW:{description:"사건 상세에서 확인과 후속 업무를 진행합니다",button:"사건 처리하기"},
 ACKNOWLEDGED:{description:"사건 상세에서 담당 지정과 후속 업무를 진행합니다",button:"사건 처리하기"},
 CLAIMED:{description:"사건 상세에서 근거를 검토하고 후속 업무를 진행합니다",button:"사건 처리하기"},
 UNDER_REVIEW:{description:"사건 상세에서 위험 판단과 후속 업무를 진행합니다",button:"사건 처리하기"},
 DISPATCH_REQUESTED:{description:"사건 상세에서 출동 요청과 진행 내용을 확인합니다",button:"진행 내용 보기"},
 DISPATCHED:{description:"사건 상세에서 출동 진행 내용을 확인합니다",button:"진행 내용 보기"},
 ON_SCENE:{description:"사건 상세에서 현장 도착과 조치 내용을 확인합니다",button:"현장 상태 보기"},
 ACTION_IN_PROGRESS:{description:"사건 상세에서 진행 중인 현장 조치를 확인합니다",button:"조치 상태 보기"},
 ACTION_COMPLETED:{description:"사건 상세에서 완료된 조치와 처리 기록을 확인합니다",button:"사건 기록 보기"},
 CLOSED:{description:"종료된 사건의 처리 기록을 확인합니다",button:"사건 기록 보기"},
 FALSE_POSITIVE:{description:"오탐으로 종료된 사건의 처리 기록을 확인합니다",button:"사건 기록 보기"},
};
...
export function SelectedIncidentPanel({incident,cctv,dispatch,dispatchLookupStatus="ready",showIncidentMetadata=false,className=""}:Props){
 ...
 const description=dispatchUnknown?(dispatchLookupStatus==="loading"?"선택 사건의 출동 정보를 확인하고 있습니다.":"최신 출동 정보를 확인하지 못했습니다. 사건 상세에서 다시 확인해 주세요."):waitingForResponder?"출동 요청이 전달되었습니다. 담당자의 응답을 기다리고 있습니다.":next.description;
 return <section className={`selected-incident-panel ${className}`} aria-label={panelTitle}>
  ...
  <footer className="selected-incident-panel__actions"><Link className="command-primary selected-incident-panel__primary" href={incidentDetailPath(incident.public_id)}><span>{next.button}</span></Link></footer>
 </section>;
}
