...
const mockDto = {
  cctvs: [
    ...
    { public_id: mockCctvPublicIds["CAM 03"], cctv_code: "CCTV-DEMO-003", cctv_name: "CAM 03", source_type: "DEMO", stream_type: "DEMO", direction_code: "DESC", operational_status: "NORMAL", has_stream: true, fallback_used: false, video_state: "DEMO", road: { road_name: "영동고속도로" }, road_section: { section_name: "여주JC ~ 이천IC" } },
  ...
  incidents: ([
    ...
    ["INC-20260719-0007", mockCctvPublicIds["CAM 04"], "CLAIMED", "DEBRIS", "BOX", "박스", 64.8, "MEDIUM", .84, 5100, 11, { public_id: "user-controller-other", display_name: "김관제" }, 1, "2026-07-19T04:54:00.000Z"],
    ["INC-20260719-0006", mockCctvPublicIds["CAM 01"], "UNDER_REVIEW", "VEHICLE", "WRONG_WAY", "역주행 차량", 88.1, "HIGH", .92, 7200, 19, { public_id: "user-controller-demo", display_name: "조정민" }, 2, "2026-07-19T04:40:00.000Z"],
    ["INC-20260719-0005", mockCctvPublicIds["CAM 06"], "DISPATCH_REQUESTED", "VEHICLE", "STOPPED_VEHICLE", "정지 차량", 75.2, "HIGH", .89, 6200, 16, { public_id: "user-controller-demo", display_name: "조정민" }, 3, "2026-07-19T04:35:00.000Z"],
    ["INC-20260719-0004", mockCctvPublicIds["CAM 03"], "DISPATCHED", "DEBRIS", "TIRE", "타이어", 61, "MEDIUM", .82, 3900, 9, { public_id: "user-controller-demo", display_name: "조정민" }, 4, "2026-07-19T04:20:00.000Z"],
    ...
    duration_ms,
    detection_count,
    representative_image_url:incident_no==="INC-20260719-0007"?"/images/incidents/cam04-box-highway-v2.png":"/images/incidents/response-ai-detection-v2.png",
    representative_image_kind:"ORIGINAL",
    detection_bbox:incident_no==="INC-20260719-0007"?{x:.505,y:.655,width:.06,height:.085}:class_code==="STOPPED_VEHICLE"?{x:.49,y:.4,width:.1,height:.12}:class_code==="WRONG_WAY"?{x:.69,y:.37,width:.07,height:.13}:class_code==="PEDESTRIAN"?{x:.68,y:.39,width:.05,height:.13}:class_code==="TIRE"||class_code==="BOX"?{x:.52,y:.55,width:.08,height:.1}:null,
    assigned_controller,
