...
export function resolveNotificationAudience(user: Pick<AuthenticatedUser,"role"> | null | undefined) {
  ...
  return {
    ...
    pageTitle:systemAdmin?"운영 알림":general?"알림":manager?"센터 업무 알림":"업무 알림",
    pageDescription:systemAdmin?"시스템 운영과 계정·권한 변경 사항을 확인합니다.":general?"계정과 서비스 관련 안내를 확인합니다":manager?"확인이 필요한 사건과 출동 변동입니다.":"확인이 필요한 사건과 출동 상태 변경을 우선순위에 따라 처리합니다.",
    breadcrumb:systemAdmin?"운영 알림":general?"알림":manager?"센터 업무 알림":"업무 알림",
    ...
    emptyTitle:general?"새로운 알림이 없습니다":manager?"현재 확인이 필요한 센터 업무 알림이 없습니다.":"새로운 업무 알림이 없습니다",
    emptyDescription:general?"계정이나 서비스 관련 안내가 도착하면 이곳에서 확인할 수 있습니다":manager?"센터 사건과 출동 변동이 발생하면 이곳에 표시됩니다.":"새로운 알림이 도착하면 이곳에서 확인할 수 있습니다.",
