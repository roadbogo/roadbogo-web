...
const operationRecords: NotificationRecord[] = [
...
const belongsToAudience = (item: NotificationRecord, user: AuthenticatedUser) =>
  user.role === "SYSTEM_ADMIN" ? Boolean(item.admin_category) : !item.admin_category;
